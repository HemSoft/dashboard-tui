...
/// <summary>
/// Pull Requests window displaying GitHub PRs
/// </summary>
public class PullRequestsWindow : Window
{
    private readonly Header _header;
    private readonly PullRequestsPlugin _pullRequestsPlugin;
    private readonly StatusBar _statusBar;
    private readonly AppConfig _config;

    public PullRequestsWindow(AppConfig config)
    {
        _config = config;
        ...
        _header = new("Pull Requests", false)  // Don't show update time in header since it's in title bar
        {
            X = 0,
            Y = 0,
            Width = Dim.Fill()
        ...
        // Create pull requests plugin
        _pullRequestsPlugin = new()
        {
            X = 1,
        ...
        Add(_header, _pullRequestsPlugin, _statusBar);

        // Set initial focus to pull requests plugin
        _pullRequestsPlugin.SetFocus();
    }
    ...
    private StatusBar CreateStatusBar()
    {
        ...
        [
            new Shortcut(Key.R.WithCtrl, "Refresh", async () => await _pullRequestsPlugin.RefreshAsync()),
